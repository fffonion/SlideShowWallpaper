...
public static class WallpaperLayoutCalculator
{
        ...
        double offsetY)
    {
        ...
        double left = (viewportWidth - width) / 2 + clampedOffsetX;
        double top = (viewportHeight - height) / 2 + clampedOffsetY;
        return new WallpaperElementLayout(width, height, left, top);
    }
