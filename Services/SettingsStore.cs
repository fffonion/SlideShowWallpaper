...
public sealed class SettingsStore
{
    ...
    private static HardwareMonitorConfig LoadHardwareMonitorConfig(Dictionary<string, Dictionary<string, string>> sections)
    {
        ...
        var config = new HardwareMonitorConfig
        {
            ...
            OverlayWidth = GetDouble(sections, section, nameof(HardwareMonitorConfig.OverlayWidth), HardwareMonitorConfig.DefaultOverlayWidth),
            OverlayHeight = GetDouble(sections, section, nameof(HardwareMonitorConfig.OverlayHeight), HardwareMonitorConfig.DefaultOverlayHeight),
    ...
    private static void AppendHardwareMonitorConfig(StringBuilder builder, HardwareMonitorConfig config)
    {
        ...
        AppendValue(builder, nameof(HardwareMonitorConfig.X), HardwareEditorLayoutService.QuantizeCoordinate(config.X, double.MaxValue));
        AppendValue(builder, nameof(HardwareMonitorConfig.Y), HardwareEditorLayoutService.QuantizeCoordinate(config.Y, double.MaxValue));
        ...
        AppendValue(builder, nameof(HardwareMonitorConfig.OverlayWidth), Math.Max(1, HardwareEditorLayoutService.QuantizeCoordinate(config.OverlayWidth, double.MaxValue)));
        AppendValue(builder, nameof(HardwareMonitorConfig.OverlayHeight), Math.Max(1, HardwareEditorLayoutService.QuantizeCoordinate(config.OverlayHeight, double.MaxValue)));
    ...
    private static void AppendHardwareOverlayElement(StringBuilder builder, HardwareOverlayElement element, int index)
    {
        ...
        AppendValue(builder, $"{prefix}.X", HardwareEditorLayoutService.QuantizeCoordinate(element.X, double.MaxValue));
        AppendValue(builder, $"{prefix}.Y", HardwareEditorLayoutService.QuantizeCoordinate(element.Y, double.MaxValue));
        AppendValue(builder, $"{prefix}.Width", Math.Max(20, HardwareEditorLayoutService.QuantizeCoordinate(element.Width, double.MaxValue)));
        AppendValue(builder, $"{prefix}.Height", Math.Max(20, HardwareEditorLayoutService.QuantizeCoordinate(element.Height, double.MaxValue)));
